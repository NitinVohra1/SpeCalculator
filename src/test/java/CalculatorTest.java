...
public class CalculatorTest {
    ...
    public void factorialFalsePositive(){
        assertNotEquals("Finding factorial of a number for False Positive", 720, calculator.factoral(5), DELTA);
    ...
    public void powerFalsePositive(){
        ...
        assertNotEquals("Finding power for False Positive", -64.3, calculator.power(4, 3), DELTA);
    }
    ...
    public void sqrootFalsePositive(){
        assertNotEquals("Finding square root for False Positive", 2, calculator.sqroot(3), DELTA);
        assertNotEquals("Finding square root for False Positive", 0, calculator.sqroot(9), DELTA);
